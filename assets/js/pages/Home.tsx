            ...
            <ul className="menu-inner py-1">
              ...
              <li className="menu-item">
                <a href="javascript:void(0);" className="menu-link menu-toggle">
                  ...
                  <div className="badge bg-label-danger rounded-pill ms-auto">
                    4
                  </div>
                </a>
                <ul className="menu-sub">
          ...
          <div className="layout-page">
            ...
            <div className="content-wrapper">
              <div className="container-xxl flex-grow-1 container-p-y">
                <div className="help-center-header rounded d-flex flex-column justify-content-center align-items-center bg-help-center">
                  <h3 className="text-center">Hello, how can we help?</h3>
                  <div className="input-wrapper mb-3 input-group input-group-lg input-group-merge">
                  ...
                  <p className="text-center px-3 mb-0">
                    Common troubleshooting topics: eCommerce, Blogging to
                    payment
                  </p>
                </div>

                <div className="help-center-popular-articles bg-help-center py-5">
                          ...
                          <div className="col-md-4 mb-md-0 mb-4">
                            <div className="card border shadow-none">
                              <div className="card-body text-center">
                                ...
                                <p>
                                  Whether you're new or you're a power user,
                                  this article will…
                                </p>
                                <a
                          ...
                          <div className="col-md-4 mb-md-0 mb-4">
                            <div className="card border shadow-none">
                              <div className="card-body text-center">
                                ...
                                <h5 className="my-2">First Steps</h5>
                                <p>
                                  Are you a new customer wondering how to get
                                  started?
                                </p>
                                <a
                                  className="btn btn-sm btn-label-primary"
                          ...
                          <div className="col-md-4">
                            <div className="card border shadow-none">
                              <div className="card-body text-center">
                                ...
                                <h5 className="my-2">Add External Content</h5>
                                <p>
                                  This article will show you how to expand the
                                  functionality of...
                                </p>
                                <a
                                  className="btn btn-sm btn-label-primary"
                ...
                <div className="help-center-knowledge-base py-5 help-center-bg-alt bg-help-center">
                  <div className="container-xl">
                    <h3 className="text-center mt-4">Knowledge Base</h3>
                    <div className="row">
                            ...
                            <div className="card">
                              <div className="card-body">
                                <div className="d-flex align-items-center mb-2">
                                  ...
                                  <h5 className="fw-semibold mt-3 ms-1">
                                    eCommerce
                                  </h5>
                                </div>
                                <ul>
                                  ...
                                  <li className="text-primary pb-1">
                                    <a href="./pages-help-center-categories.html">
                                      Square Sync
                                    </a>
                                  </li>
                              ...
                              <div className="card-body">
                                <div className="d-flex align-items-center mb-2">
                                  <span className="badge bg-label-danger p-2 rounded me-2">
                                    <i className="ti ti-world ti-sm"></i>
                                  </span>
                                  <h5 className="fw-semibold mt-3 ms-1">
                                    Domains and Email
                                  </h5>
                              ...
                              <div className="card-body">
                                <div className="d-flex align-items-center mb-2">
                                  <span className="badge bg-label-warning p-2 rounded me-2">
                                    <i className="ti ti-device-mobile ti-sm"></i>
                                  </span>
                                  <h5 className="fw-semibold mt-3 ms-1">
                                    Mobile Apps
                                  </h5>
                ...
                <div className="help-center-keep-learning bg-help-center py-5">
                  <div className="container-xl">
                    <h3 className="text-center my-4">Keep Learning</h3>
                    <div className="row">
                      <div className="col-lg-10 mx-auto mb-4">
                        <div className="row">
                          <div className="col-md-4 mb-md-0 mb-4">
                            <div className="card border shadow-none">
                              <div className="card-body text-center">
                                ...
                                <h5 className="my-2">Blogging</h5>
                                <p className="mb-3">
                                  Expert tips and tools to improve your website
                                  or online store using our blog.
                                </p>
                                <a
                                  className="btn btn-sm btn-label-primary"
                                  href="./pages-help-center-categories.html"
                          ...
                          <div className="col-md-4 mb-md-0 mb-4">
                            <div className="card border shadow-none">
                              <div className="card-body text-center">
                                ...
                                <h5 className="my-2">Inspiration Center</h5>
                                <p className="mb-3">
                                  Inspiration from experts to help you start and
                                  grow your big ideas.
                                </p>
                                <a
                                  className="btn btn-sm btn-label-primary"
                ...
                <div className="help-center-contact-us help-center-bg-alt">
                  <div className="container-xl">
                    <div className="row justify-content-center py-5">
                      <div className="col-md-8 col-lg-6 text-center mt-4">
                        <h3>Still need help?</h3>
                        <p className="mb-3">
                          Our specialists are always happy to help. Contact us
                          during standard business hours or email us 24/7 and
